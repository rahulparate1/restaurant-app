...
export const LeaveStatus = [
  {
    id: 1,
    label: 'Approved',
    className: 'badge bg-success p-2 rounded bx bx-check-circle',
  },
  {
    id: 2,
    label: 'Rejected',
    className: 'badge bg-danger p-2 rounded bx bx-x-circle',
  },
  {
    id: 3,
    label: 'Pending',
    className: 'badge bg-warning p-2 rounded bx bx-time-five',
  },
];
...
const ImageExtensionsLeaves = ['jpg', 'png', 'svg', 'jpeg', 'wabp', 'pdf'];
