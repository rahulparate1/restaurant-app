    ...
    intercept(request: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>> {
        ...
        return of(null).pipe(mergeMap(() => {
            ...
            if (request.url.endsWith('/users/authenticate') && request.method === 'POST') {
                ...
                if (filteredUsers.length) {
                    ...
                    const body = {
                        ...
                        token: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY2N2U1ZjIwMmZmNzMxNTdkNThkNzFjMyIsIm5hbWUiOiJBbmphbGkgV2FnaG1hcmUiLCJyb2xlcyI6WyJhZG1pbiJdLCJpYXQiOjE3MzExNzUxODEsImV4cCI6MTczMzc2NzE4MX0.KP0oNbtmSDsCpvF2eeua2cTS0wKSyI_XBu92ivEBfAQ'
                    };
            ...
            if (request.url.match(/\/users\/\d+$/) && request.method === 'GET') {
                ...
                if (request.headers.get('Authorization') === 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY2N2U1ZjIwMmZmNzMxNTdkNThkNzFjMyIsIm5hbWUiOiJBbmphbGkgV2FnaG1hcmUiLCJyb2xlcyI6WyJhZG1pbiJdLCJpYXQiOjE3MzExNzUxODEsImV4cCI6MTczMzc2NzE4MX0.KP0oNbtmSDsCpvF2eeua2cTS0wKSyI_XBu92ivEBfAQ') {
