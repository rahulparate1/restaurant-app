...
import { GeneralFeedComponent } from './pages/general-feed/general-feed.component';
...
const routes: Routes = [
  ...
  { path: 'exit',loadChildren: () => import('./exit-documents/exit-documents.module').then(  (m) => m.ExitDocumentsModule ) },
